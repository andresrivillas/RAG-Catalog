...
DEFAULT_PROFILES: Dict[str, IndustryProfile] = {
    "arquitectura": IndustryProfile(
        ...
        prefer=[
            ...
            "elegancia", "cuero", "aluminio", "metal", "vidrio", "termo",
            "maletin", "maletín", "portafolio", "paraguas", "viaje",
        ],
        avoid=[
            "mascotas", "mascota", "correa", "bowl", "juguete", "infantil",
            "niños", "ninos", "cocina", "bebe", "bebé", "animal", "herramienta",
            "metro", "llavero", "plastico", "plástico", "barato",
        ],
        context_tags=["oficina", "escritorio", "diseno", "diseño", "planos", "construccion", "construcción", "elegancia", "premium"],
        preferred_categories=["oficina", "escritura", "viaje", "tecnologia", "hogar"],
        preferred_tags=["premium", "ejecutivo", "personalizable", "organizacion", "libreta", "agenda", "maleta", "diseño", "elegancia"],
        preferred_materials=["cuero", "madera", "bambu", "metal", "aluminio", "vidrio", "acero"],
        preferred_roles=["CORE", "PREMIUM", "UTILITY"],
        blacklisted_categories=["mascotas", "juguetes", "cocina", "bebe", "herramientas"],
        blacklisted_tags=["juguete", "infantil", "mascota", "cocina", "herramienta", "metro", "llavero", "plastico", "plástico"],
    ),
    ...
    "tecnologia": IndustryProfile(
        "tecnologia",
        prefer=[
            "usb", "cargador", "gadget", "wireless", "mouse", "oficina moderna",
            "tecnologia", "tecnología", "auricular", "power bank", "cable",
            "electronica", "electrónica", "innovacion", "innovación",
            "soporte movil", "soporte móvil", "hub", "memoria usb", "adaptador",
            "bluetooth", "altavoz", "parlante", "organizador", "escritorio",
        ],
        avoid=["mascotas", "mascota", "juguete", "cocina", "infantil", "herramienta", "metro", "llavero"],
        context_tags=["tecnologia", "tecnología", "oficina", "gadget", "branding", "innovacion", "innovación"],
        preferred_categories=["tecnologia", "oficina", "escritura"],
        preferred_tags=["usb", "cargador", "gadget", "wireless", "auricular", "power bank", "tecnicos", "hub", "bluetooth", "soporte movil"],
        preferred_materials=["metal", "aluminio", "silicona", "plastico", "bambu", "madera"],
        preferred_roles=["CORE", "UTILITY", "PROMOTIONAL"],
        blacklisted_categories=["mascotas", "juguetes", "cocina", "herramientas"],
        blacklisted_tags=["juguete", "infantil", "mascota", "cocina", "metro", "llavero", "herramienta", "casco", "regla"],
    ),
    "software": IndustryProfile(
        ...
        preferred_materials=["metal", "aluminio", "silicona", "plastico", "bambu", "madera"],
        preferred_roles=["CORE", "UTILITY", "PROMOTIONAL"],
        blacklisted_categories=["mascotas", "juguetes", "cocina", "salud", "higiene", "herramientas"],
        blacklisted_tags=["cepillo", "pastillero", "borrador", "escolar", "utiles escolares", "poncho", "higiene", "salud", "metro", "llavero", "herramienta", "casco", "regla"],
    ),
    "salud": IndustryProfile(
        ...
        prefer=[
            ...
            "confort", "higiene", "desinfectante", "antibacterial", "oficina",
        ],
        avoid=["mascotas", "mascota", "juguete", "infantil", "cocina", "herramienta", "metro", "llavero"],
        context_tags=["termos", "escritorio", "libretas", "organizacion", "organización", "bienestar", "higiene", "salud"],
        preferred_categories=["hogar", "oficina", "viaje", "salud", "bolsos"],
        preferred_tags=["bienestar", "salud", "hidratacion", "botella", "termo", "higiene", "desinfectante", "confort"],
        preferred_materials=["acero", "bambu", "aluminio", "vidrio", "plastico"],
        preferred_roles=["CORE", "UTILITY"],
        blacklisted_categories=["mascotas", "juguetes", "cocina", "escritura escolar", "herramientas"],
        blacklisted_tags=["juguete", "infantil", "mascota", "cocina", "escolar", "herramienta", "metro", "llavero", "casco", "regla"],
    ),
    "hospital": IndustryProfile(
        ...
        avoid=["mascotas", "mascota", "juguete", "infantil", "cocina", "herramienta", "metro", "llavero"],
        context_tags=["salud", "medicos", "médicos", "bienestar", "oficina", "higiene"],
        preferred_categories=["hogar", "oficina", "viaje", "salud", "bolsos"],
        preferred_tags=["bienestar", "salud", "hidratacion", "botella", "termo", "higiene", "desinfectante", "confort"],
        preferred_materials=["acero", "bambu", "aluminio", "vidrio", "plastico"],
        preferred_roles=["CORE", "UTILITY"],
    ...
    "vip": IndustryProfile(
        ...
        prefer=[
            ...
            "limitada", "detalle", "maletin", "maletín", "paraguas", "viaje",
            "reloj", "vinos", "vino", "coffee", "cafetera", "termo",
        ],
        avoid=["mascotas", "mascota", "juguete", "infantil", "plástico", "plastico", "barato", "herramienta", "metro", "llavero", "aspiradora", "repuesto", "coca"],
        context_tags=["premium", "lujo", "ejecutivo", "alta gama", "exclusivo"],
        preferred_categories=["viaje", "oficina", "escritura", "tecnologia", "hogar"],
        preferred_tags=["premium", "lujo", "exclusivo", "alta gama", "cuero", "metal", "madera", "ejecutivo"],
        preferred_materials=["cuero", "metal", "madera", "bambu", "aluminio", "vidrio", "acero"],
        preferred_roles=["CORE", "PREMIUM", "UTILITY"],
        blacklisted_categories=["mascotas", "juguetes", "plastico", "herramientas", "otros"],
        blacklisted_tags=["juguete", "infantil", "mascota", "plastico", "barato", "herramienta", "metro", "llavero", "aspiradora", "repuesto", "coca"],
    ),
